...
.ovw-btn{padding:9px 13px;border:1px solid var(--border);border-radius:8px;background:var(--surface-2);color:var(--text-1);font:inherit;font-weight:700;cursor:pointer}.ovw-primary{border-color:var(--primary);background:var(--primary);color:white}.ovw-btn:focus-visible,input:focus-visible,select:focus-visible,summary:focus-visible{outline:3px solid var(--primary);outline-offset:2px}.ovw-btn:disabled{opacity:.5}.ovw-actions{justify-content:flex-end;margin-top:16px}
