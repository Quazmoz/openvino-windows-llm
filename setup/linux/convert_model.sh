...
usage() {
    cat <<'EOF'
Convert a catalog model to OpenVINO IR on Linux.

Usage:
  ./setup/linux/convert_model.sh --id <model_id> [--load-after]
  ./setup/convert_model.sh --id <model_id> [--load-after]     # compatibility wrapper
