...
|---|---|---|---|---|---|---|
| 0.4.0 | All | Real installer upgrade, downgrade, signing, CPU, GPU, and NPU paths are not established by source or Linux validation alone. | Run the documented Windows packaging, signing, upgrade, and certification procedures before publishing compatibility claims. | Not yet verified | Release validation report | Unverified |
