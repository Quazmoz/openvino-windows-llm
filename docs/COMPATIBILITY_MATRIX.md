...
| App version | Windows | Arch | CPU | GPU | NPU | OpenVINO | GenAI | Driver | Model | Precision | Requested | Actual | Load | Benchmark | Report | Date | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| _No production certification rows recorded for 0.4.0_ | | | | | | | | | | | | | | | | | |
